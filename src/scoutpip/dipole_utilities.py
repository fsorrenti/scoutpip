...
def omm(z, omegam0):
    """
    Definition of the omega matter function
    """
...
def fz(z, omegam0):
    """
    Definition of the scale function
    """
    return (
        omm(z, omegam0)
...
def dl_monopole(z, H0, Omat):
    """
    Definition of unperturbed luminosity distance
    """
    c = 299792.458
    return (
...
"""
I define in the following the functions for the redshift corrections
"""
...
def z_monopole_bulk(
    ...
    """
    Peculiar velocities (bulk+monopole) and CMB corrected redshift
    """   
    return (
        (1 + z_cmb_cross(z, v, ra_sun_in_deg, dec_sun_in_deg, ra, dec))
        / (
...
def z_monopole_dipole_cross(
    ...
    """
    CMB and monopole corrected redshift
    """  
    return (
...
def z_quadrupole_bulk(
    ...
    """
    CMB, monopole and quadrupole corrected redshift
    """ 
    return (
        (1 + z_cmb_cross(z, v, ra_sun_in_deg, dec_sun_in_deg, ra, dec))
        / (
...
"""
We now define the filter functions to apply to the dataset
"""
